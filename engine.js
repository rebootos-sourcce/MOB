...
/* ============================================================
   WHERE AN ADDRESS REALLY SITS, WHERE THAT IS KNOWN.

   Every address on the Body page was placed by a hash of its number: a
   scattered spot on an oval round its seat's centre, with anatomy playing no
   part. In the head that oval is wider than the skull, so the clip to the
   silhouette hid 11 of the 12 3rd Eye addresses and 15 of the 21 Crown ones
   on every profile, however heavy they were (proto/anatomy-check, BZ).

   Ruled 26 September: place everything as close as it can, precision but
   feel, roughly the right spot. And a plexus branches, so more than two
   addresses may share one real place. So each row below is one real place
   and every address standing on it. The renderer spreads the ones sharing
   a place round it rather than stacking them, and an address in no row
   keeps the old placement, which is the honest answer for a place nobody
   has measured yet.

   The numbers are sources, not figure units, so they can be checked against
   where they came from.

   h   the head. Brain atlas centroids in MNI millimetres, [x, z]: x is the
       person's right, z is height. From the second anatomy pass (BQ, its
       measure_out.json, Harvard-Oxford, Juelich and Neuromorphometrics). A
       structure with two halves carries each half as its own point, measured
       from the same atlas labels split at the midline, because its whole
       centroid falls on the midline between them where no tissue is. The
       addresses of a row are dealt across its points in order.
   v   the torso. [vertebral level, offset from the midline in figure units],
   ...
   nucleus inside the structure that holds it, an axis at the middle of its
   two ends.
   ============================================================ */
/* The head ruler, from the same pass: the top of the skull under the topknot,
   figure height 4.2, is the Colin27 vertex, and the middle of the drawn ear,
   figure height 12.0, is the Colin27 ear points. One scale serves both axes,
   so a millimetre across is a millimetre down. */
var ANATHEAD={ytop:4.2, year:12.0, topZ:100.2, earZ:-48.0};
/* The spine ruler: vertebral level to figure height, through the four seats
   whose own text names a level. Heart T4 to T5, Solar T12 to L1, Sacral L5,
   Root the tailbone. */
var ANATSPINE=[[11.5,30.51],[19.5,40.21],[24,47.02],[30,53.55]];
var ANAT=[
 /* 3rd Eye. The chiasm is the brow line, which is where the seat's own text
    puts it: between the eyebrows. */
 {s:'Optic chiasm, and the optic nerves that meet in it', ids:[79,76], h:[[0.5,-19.4]]},
 {s:'Lateral geniculate', ids:[83], h:[[24.8,-8.5],[-22.4,-9.4]]},
 {s:'Visual cortex', ids:[82], h:[[-8.3,3.5],[14.0,3.6]]},
 {s:'Optic radiation, the nearest real structure to cortical visual pathway',
  ids:[85], h:[[-29.1,-0.3],[30.3,1.1]]},
 {s:'Thalamus', ids:[87], h:[[11.1,7.0],[-10.2,6.7]]},
 /* the pineal is measured as a region estimate. The epithalamus is the pineal
    with the habenula and the posterior commissure, so all three stand here:
    three addresses on one real place, the case the ruling names. */
 {s:'Pineal region: pineal, epithalamus, posterior commissure', ids:[80,105,101], h:[[0.6,1.0]]},
 /* the occipital nerve is a scalp nerve and no brain atlas holds it. It
    rises at the back of the skull beside the inion, and Colin27 measures the
    inion (Iz) at z -23.1. */
 {s:'Occipital nerve, at the inion', ids:[84], h:[[0.0,-23.1]]},
 /* Crown */
 {s:'Top of the brain on the midline, under the superior sagittal sinus', ids:[107], h:[[2.0,77.0]]},
 {s:'Parietal lobe', ids:[91], h:[[34.4,42.6],[-34.4,42.3]]},
 {s:'Posterior cingulate', ids:[95], h:[[0.6,32.3]]},
 {s:'Anterior cingulate', ids:[97], h:[[0.8,23.9]]},
 {s:'Corpus callosum', ids:[88], h:[[1.3,17.0]]},
 /* nested, per the research: prefrontal inside frontal inside the whole
    cortex, and the neocortex is nearly all of it. Four names on one
    structure share its two halves rather than landing on each other. */
 {s:'Cerebral cortex, and the lobe and regions inside it', ids:[94,106,93,89],
  h:[[30.6,15.1],[-30.3,14.8]]},
 {s:'Default mode network, its core regions', ids:[99], h:[[-18.5,12.5],[21.2,14.8]]},
 {s:'Temporal lobe', ids:[102], h:[[42.5,-20.0],[-41.8,-20.2]]},
 {s:'Hippocampus', ids:[104], h:[[-25.4,-15.0],[27.0,-14.9]]},
 /* measured as the ventral diencephalon, which holds the hypothalamus. The
    supraoptic nucleus sits inside it, and the medial forebrain bundle runs
    through its lateral part. */
 {s:'Hypothalamus, with the supraoptic nucleus and the medial forebrain bundle',
  ids:[103,86,100], h:[[0.2,-11.1]]},
 /* axes are not places. Each sits at the middle of the two it names. */
 {s:'Pineal to hypothalamus, the middle of the axis', ids:[90], h:[[0.4,-5.05]]},
 {s:'Pineal to amygdala, the middle of the axis', ids:[98], h:[[-11.2,-8.55]]},
 /* the brainstem, upper part the midbrain. The oculomotor nerve leaves the
    midbrain and the dorsal raphe sits in it. The abducens and trigeminal
    nerves leave the pons, inside the reticular formation's own span. */
 {s:'Midbrain: dorsal raphe, oculomotor nerve', ids:[92,77], h:[[0.5,-16.5]]},
 {s:'Brainstem: reticular formation, trigeminal and abducens nerves', ids:[96,81,78], h:[[0.6,-34.0]]},
 /* Ascension Column is not anatomy (BQ). It stands where it is filed. */
 {s:'No structure. Filed at the Crown', ids:[108], at:'crown'},
 /* Torso. The six the passes sourced to a level. */
...
/* ============================================================
   ...
   GENERATED by tools/zonetab.py from zone.tab, tzdata 2025b,
   418 rows. Do not edit by hand: regenerate, and the engine gate
   ...
   ============================================================ */
const ZONEPT={
 Africa:'Abidjan+0519-00402 Accra+0533-00013 Addis_Ababa+0902+03842 Algiers+3647+00303 Asmara+1520+03853 Bamako+1239-00800 Bangui+0422+01835 Banjul+1328-01639 Bissau+1151-01535 Blantyre-1547+03500 Brazzaville-0416+01517 Bujumbura-0323+02922 Cairo+3003+03115 Casablanca+3339-00735 Ceuta+3553-00519 Conakry+0931-01343 Dakar+1440-01726 Dar_es_Salaam-0648+03917 Djibouti+1136+04309 Douala+0403+00942 El_Aaiun+2709-01312 Freetown+0830-01315 Gaborone-2439+02555 Harare-1750+03103 Johannesburg-2615+02800 Juba+0451+03137 Kampala+0019+03225 Khartoum+1536+03232 Kigali-0157+03004 Kinshasa-0418+01518 Lagos+0627+00324 Libreville+0023+00927 Lome+0608+00113 Luanda-0848+01314 Lubumbashi-1140+02728 Lusaka-1525+02817 Malabo+0345+00847 Maputo-2558+03235 Maseru-2928+02730 Mbabane-2618+03106 Mogadishu+0204+04522 Monrovia+0618-01047 Nairobi-0117+03649 Ndjamena+1207+01503 Niamey+1331+00207 Nouakchott+1806-01557 Ouagadougou+1222-00131 Porto-Novo+0629+00237 Sao_Tome+0020+00644 Tripoli+3254+01311 Tunis+3648+01011 Windhoek-2234+01706',
