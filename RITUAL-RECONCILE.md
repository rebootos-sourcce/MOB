...
**Method A. The nine sections whose heading names the ritual.** These are
`0h2`, `0j2`, `0m`, `0q`, `0t`, `0y`, `0d`, `0f` and `0v` at line 5052. The
span of each runs to the next `##`, so its subsections are inside it.
