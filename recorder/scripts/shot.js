...
// MOB_NO_FAKE omits the synthetic devices so the no-camera error states render.
if (!process.env.MOB_NO_FAKE) args.push('--use-fake-device-for-media-stream', '--use-fake-ui-for-media-stream');
